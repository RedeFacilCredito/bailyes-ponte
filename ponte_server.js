// ponte_server.js (Versão Final - Com Health Check Corrigido)
...
// --- CONSTANTES ---
// *** CORREÇÃO: Movido para depois da importação do 'config' ***
const HEALTH_CHECK_INTERVAL_MS = (config.HEALTH_CHECK_INTERVAL_MINUTES || 3) * 60 * 1000;
...
const STATUS_REQUEST_TIMEOUT = config.STATUS_REQUEST_TIMEOUT || 5 * 60 * 1000;
...
async function initializeWorker() {
    ...
    // *** CORREÇÃO: Função movida para o escopo correto (dentro de initializeWorker) ***
    ...
    app.post('/webhook/chatwoot', async (req, res) => {
        ...
        const managementCommand = config.WEBHOOK_COMMAND_KEYWORD;
    ...
    async function startWorkerServer() {
        ...
        // *** CORREÇÃO: Chamada para iniciar o health check ***
        setInterval(runHealthChecks, HEALTH_CHECK_INTERVAL_MS);
        // *** CORREÇÃO: Log duplicado removido e mensagem do health check adicionada ***
